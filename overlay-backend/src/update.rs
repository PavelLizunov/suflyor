...
/// Enforces repository matching on github.com URLs to prevent downloading from
...
mod tests {
    ...
    fn untrusted_download_host_rejected() {
        ...
        assert!(!is_trusted_download(
            "https://github.com/other-user/other-repo/releases/download/v0.2.0/suflyor-slint-setup.exe"
        ));
